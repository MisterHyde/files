-- Converted from hyprland.conf (hyprlang) to the Lua config (Hyprland >= 0.55)
-- Refer to the wiki: https://wiki.hypr.land/Configuring/Start/
-- Place at ~/.config/hypr/hyprland.lua
--
-- Split into multiple files with require (extension omitted, path relative
-- to this file):
-- require("myColors")
...
-- Use a new global dconf profile for hyprland
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/hyprpaper-random"))
...
-- Screenshots
hl.bind("Print", hl.dsp.exec_cmd("DEFAULT_TARGET_DIR=~/Pictures/Screenshots/ grimblast copysave area"))
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("DEFAULT_TARGET_DIR=~/Pictures/Screenshots/ grimblast copysave screen"))
